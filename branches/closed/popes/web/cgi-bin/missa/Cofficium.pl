...
if ($rubrics != strictparam('rubrics')) {$rubrics = strictparam('rubrics'); $flag = 1;}
if ($solemn != strictparam('solemn')) {$solemn = strictparam('solemn'); $flag = 1;}
if ($flag) {
  setsetup('generalc', $version1, $version2, $lang2, $rubrics, $solemn);
...
print << "PrintTag";
<P ALIGN=CENTER><I>
Rubrics : <INPUT TYPE=CHECKBOX NAME='rubrics' VALUE=1 $crubrics onclick="parchange()">
&nbsp;&nbsp;&nbsp;
