...
our $commemorated; #name of the commemorated
...
if (!$votive) {$votive = strictparam('votive1');}
...
$flag = 0;
$p = strictparam('lang2');
if (!$p) {$p = strictparam('lang21');}
if ($p) {$lang2 = $p; $flag = 1;}
$p = strictparam('version');
if (!$p) {$p = strictparam('version1');}
if ($p) {$version = $p; $flag = 1;}
$p = strictparam('expand');
if (!$p) {$p = strictparam('expand1');}
...
print << "PrintTag";
<P ALIGN=CENTER><I>
<A HREF='Bofficium.pl?command=prayMatutinum'><FONT COLOR=$hcolor[1]>$horas[1]</FONT></A>
&nbsp;&nbsp; 
<A HREF='Bofficium.pl?command=prayLaudes'><FONT COLOR=$hcolor[2]>$horas[2]</FONT></A>
&nbsp;&nbsp; 
<A HREF='Bofficium.pl?command=prayPrima'><FONT COLOR=$hcolor[3]>$horas[3]</FONT></A>
&nbsp;&nbsp; 
<A HREF='Bofficium.pl?command=prayTertia'><FONT COLOR=$hcolor[4]>$horas[4]</FONT></A>
&nbsp;&nbsp; 
<A HREF='Bofficium.pl?command=praySexta'><FONT COLOR=$hcolor[5]>$horas[5]</FONT></A>
&nbsp;&nbsp; 
<A HREF='Bofficium.pl?command=prayNona'><FONT COLOR=$hcolor[6]>$horas[6]</FONT></A>
&nbsp;&nbsp; 
<A HREF='Bofficium.pl?command=prayVespera'><FONT COLOR=$hcolor[7]>$horas[7]</FONT></A>
&nbsp;&nbsp; 
<A HREF='Bofficium.pl?command=prayCompletorium'><FONT COLOR=$hcolor[8]>$horas[8]</FONT></A>
</I></P>
PrintTag
} else {
print << "PrintTag";
...
PrintTag
  ...
  $ch1 = ($expand =~ /all/i) ? 'red' : 'blue';
  $ch2 = ($expand =~ /psalms/i) ? 'red' : 'blue';
  ...
  print << "PrintTag";
<P ALIGN=CENTER>
<TABLE ALIGN=CENTER BORDER=1 CELLPADDING=5><TR><TD ALIGN=CENTER VALIGN=MIDDLE>
<FONT SIZE=1>Expand<BR></FONT>
<A HREF='Bofficium.pl?expand=all'><FONT COLOR=$ch1>all</FONT></A><BR>
<A HREF='Bofficium.pl?expand=psalms'><FONT COLOR=$ch2>psalms</FONT></A>
</TD>
<INPUT TYPE=HIDDEN NAME=expand1 VALUE="$expand">
PrintTag
  ...
  for ($i = 0; $i < @versions; $i++) {
    if ($i > 0) {print "<BR>";}
	print "<A HREF='Bofficium.pl?version=$versions[$i]'><FONT COLOR=$chv[$i]>$versions[$i]</FONT></A>";
  }
  print "<INPUT TYPE=HIDDEN NAME=version1 VALUE=\"$version\">\n";
  print "</TD>\n";
...
<A HREF='Bofficium.pl?testmode=regular'><FONT COLOR=$sel10>regular</FONT></A><BR>
<A HREF='Bofficium.pl?testmode=seasonal'><FONT COLOR=$sel11>seasonal</FONT></A><BR>
</TD>
<INPUT TYPE=HIDDEN NAME=testmode1 VALUE="$testmode">
PrintTag
...
<A HREF='Bofficium.pl?lang2=Latin'><FONT COLOR=$chl1>Latin</FONT></A><BR>
<A HREF='Bofficium.pl?lang2=English'><FONT COLOR=$chl2>English</FONT></A><BR>
<A HREF='Bofficium.pl?lang2=Magyar'><FONT COLOR=$chl3>Magyar</FONT></A><BR>
</TD><TD ALIGN=CENTER VALIGN=MIDDLE
<FONT SIZE=1>Votive</FONT><BR>
<A HREF='Bofficium.pl?votive=hodie'><FONT COLOR=$sel1>hodie</FONT></A><BR>
<A HREF='Bofficium.pl?votive=C8'><FONT COLOR=$sel2>Dedication</FONT></A><BR>
<A HREF='Bofficium.pl?votive=C9'><FONT COLOR=$sel3>Defunctorum</FONT></A><BR>
<A HREF='Bofficium.pl?votive=C12'><FONT COLOR=$sel4>Parvum B.M.V.</FONT></A><BR>
</TD></TR></TABLE><BR>
<INPUT TYPE=HIDDEN NAME=lang21 VALUE="$lang2">
<INPUT TYPE=HIDDEN NAME=votive1 VALUE="$votive">
<P ALIGN=CENTER><FONT SIZE=-1>
<A HREF="Cofficium.pl">Compare</A>
&nbsp;&nbsp;&nbsp;&nbsp; 
<A HREF=edit.pl?lang=$lang2&date=$date1" TARGET="_NEW">Show files</A>
&nbsp;&nbsp;&nbsp;&nbsp; 
<A HREF='Bofficium.pl?command=setupparameters')">Options</A>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
&nbsp;&nbsp;&nbsp;
<A HREF='kalendar.pl' target="_new">Kalendar</A>
</P>
PrintTag
}
