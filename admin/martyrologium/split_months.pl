...
#
# Was kept as m.pl in each Martyrologium folder; one copy lives here now.
# Run it in a folder of 01.txt .. 12.txt and it writes MM-DD.txt, which is
# what import_translation.py takes as input.
